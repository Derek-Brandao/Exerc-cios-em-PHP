<html>
	...
	<body style="background-image: url('uauuu.jpg'); height: 100%; overflow-y:hidden; overflow-x:hidden; background-size: cover;background-repeat: no-repeat;">
		...
		<big><center><big><form action ="validar.php" method="post" style="color: white; padding: 0; border: 3px dotted white; width: 400; height: 230px; position: relative; top: 300;border-radius: 20px;" id="form">
		<br/>
		...
		<form action="redefinirsenha.php" method="post" style="position relative; top: 500px">
		<?php
		...
		<big><big><a href="index.html" style="position:relative; top:540px;color:white;">Voltar ao Menu</a></big></big>
				<?php
				session_start();
				ini_set('display_errors', 0 );
				error_reporting(0);
