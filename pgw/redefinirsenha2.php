<html>
	...
	<body style="background-image: url('uauuuu.jpg'); height: 100%; overflow-y:hidden; overflow-x:hidden; background-size: cover;background-repeat: no-repeat; block-size: aut;">
		...
		<big><center><big><form action ="validar4.php" method="post" style="color: white; padding: 0; border: 3px dotted white; width: 400;border-radius: 20px; height: 230px; position: relative; top: 300;" id="form">
		<br/>
        ...
        <a href="projeto3.php" style="position:relative; right: 910px;top:608px;color:white;">Voltar</a></big>
            <?php
            session_start();
            ini_set('display_errors', 0 );
            error_reporting(0);
                if ($_SESSION["error"]==1) {
                            echo "<center><h3 style='color: white; position: relative; top: 290px'>&nbsp;&nbsp;&nbsp;Usuário inexistente.</h3></center>";
                            $_SESSION["error"] = 0;
                        }
                        else{
                            $nick = $_POST['nome'];
